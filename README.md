...
This project implements a regression model that predicts Uber fare amounts based on trip characteristics such as pickup/dropoff location, distance, time of day, and passenger count.
---
...
├── uber-fare-prediction-final.ipynb  # Complete end-to-end notebook (EDA → modeling → evaluation)
└── README.md
